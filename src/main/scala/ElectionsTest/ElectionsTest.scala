...
class PresidentialElectionsResultProcessing extends ElectionsResultProcessing{
  type ElectionsType = PresidentialElections
...
class PresidentialElectionsManager(override val notificationName: String, override val electors: Set[Voting], val candidates: Array[Candidate]) extends ElectionsManager(notificationName, electors) {
  type ElectionsType = PresidentialElections
  type VotingPaperType = PresidentialElectionsVotingPaper
